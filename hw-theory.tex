...
Поясним, что мы понимаем под <<исключить>>.
Как вы знаете, конъюнкция и отрицание
выражаются через <<и-не>>, например, так выражается отрицание: $\neg \alpha := \alpha\ |\ \alpha$. При такой замене все схемы аксиом для конъюнкции и отрицания должны стать теоремами.
При этом множество доказуемых в исчислении формул должно остаться без изменений.
