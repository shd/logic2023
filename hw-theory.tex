...
\item $(A \rightarrow C) \with (B \rightarrow C) \with (A \vee B \rightarrow C) \rightarrow C$
...
\item Выразимое в интуиционистском исчислении высказываний правило де-Моргана для импликации
\item $\bot$
\end{enumerate}
