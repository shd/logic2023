...
\vspace{-0.3cm}
\begin{exmprus}
Рассмотрим $X=\{1;1.4;1.41;1.414;1.4142;\ldots\}$~--- множество десятичных приближений $\sqrt{2}$, $\mathcal{U}=\mathbb{Q}$, ${\preceq}={\leqslant}$.
Тогда $\operatorname{upb}_{U}X$ состоит из рациональных чисел, б\'{о}льших $\sqrt{2}$. При этом $\sqrt{2}\notin\operatorname{upb}_{U}X$, а значит $\nexists\sup_{\mathbb{Q}}X$.
\end{exmprus}
